...
.tutorialContainer-1v44GL .pill-2uzAFe {
  display: none;
}
...
#app-mount .wrapper-1Rf91z .scroller-2TZvBN .tutorialContainer-1v44GL+div {
  margin-top: 58px;
}
...
#app-mount .circleIconButton-jET_ig svg {
  height: 24px;
  width: 24px;
  position: unset;
  left: unset;
...
.sansAttachButton-td2irx:not(.innerDisabled-1YTFPN) {
  padding-left: 0px
}

.sansAttachButton-td2irx > .textArea-12jD-V {
  margin-left: 16px;
}
...
#app-mount .notice-2X5hT5 .colorStandard-2KCXvj {
  margin-left: 80px;
  margin-right: 25px;
}
...
#app-mount .notice-2FJMB4 .lookFilled-1Gx00P.colorPrimary-3b3xI6,
.notice-2FJMB4 .lookFilled-1Gx00P.colorBrand-3pXr91 {
...
.notice-2FJMB4 .header-1g25vm {
  font-size: 0px;
  transition: all 200ms ease-in-out;
}

.notice-2FJMB4:hover .lookFilled-1Gx00P.colorPrimary-3b3xI6,
.notice-2FJMB4:hover .lookFilled-1Gx00P.colorBrand-3pXr91 {
  transform: scaleY(1)
}

.notice-2FJMB4:hover .header-1g25vm {
  font-size: 14px;
}
...
#pluginNotice .closeButton-3cJIM4 {
  opacity: 1;
  height: 36px;
  margin-right: 100px;
  transition: all .2s linear;
...
.searchResultsWrap-3-pOjs .searchResult-9tQ1uo:before {
  background-image: linear-gradient(0deg, rgba(47, 49, 54, 0), var(--primary-color)) !important;
}

.searchResultsWrap-3-pOjs .searchResult-9tQ1uo:after {
  background-image: linear-gradient(180deg, rgba(47, 49, 54, 0), var(--primary-color)) !important;
}

.searchResultsWrap-3-pOjs .searchResult-9tQ1uo .searchResultMessage-1fxgXh.hit-1fVM9e  {
  border: 2px solid var(--quaternary-color) !important;
}

.searchResultMessage-1fxgXh.hit-1fVM9e .avatar-1BDn8e {
  top: 14px;
}

.searchResult-9tQ1uo .hit-1fVM9e {
  background-color: var(--quaternary-color) !important;
  box-shadow: 0 0 10px 6px var(--primary-color) !important;
  padding: 5px 0;
}

.searchResult-9tQ1uo .hit-1fVM9e:hover,
.expanded-w_LCGl .searchResultMessage-1fxgXh.hit-1fVM9e {
  border: 2px solid var(--main-color) !important;
}

.searchResultsWrap-3-pOjs .channelSeparator-1DOiGt:before {
  display: none;
}

.searchResultsWrap-3-pOjs .channelSeparator-1DOiGt .channelName-1JRO3C {
  background-color: var(--main-color) !important;
  color: #fff;
  margin-left: -10px;
...
.searchResultsWrap-3-pOjs .jumpButton-JkYoYK {
  background-color: var(--main-color) !important;
  color: #fff;
...
.colorable-1bkp8v.primaryLight-1_NQ7Q:hover {
  background-color: var(--hover-color);
}
...
.colorable-1bkp8v.primary-3NQg8g.active-1QRrIS, 
.colorable-1bkp8v.primary-3NQg8g:hover {
  background-color: var(--hover-color);
}
...
.wrapper-3t9DeA foreignObject+svg rect[fill="#43b581"] {
  -webkit-text-stroke-color: var(--online);
  stroke: var(--online);
}

rect[fill="#f04747"] + .dots-3Bkt3k {
  color: var(--dnd);
}
...
.wrapper-3t9DeA foreignObject+svg rect[fill="#f04747"] {
  -webkit-text-stroke-color: var(--dnd);
  stroke: var(--dnd);
}

rect[fill="#faa61a"] + .dots-3Bkt3k {
  color: var(--idle);
}
...
.wrapper-3t9DeA foreignObject+svg rect[fill="#faa61a"] {
  -webkit-text-stroke-color: var(--idle);
  stroke: var(--idle);
}

rect[fill="#593695"] + .dots-3Bkt3k {
  color: var(--streaming);
}
...
.wrapper-3t9DeA foreignObject+svg rect[fill="#593695"] {
...
.wrapper-3t9DeA foreignObject+svg rect[fill="#747f8d"] {
  stroke: var(--offline);
  -webkit-text-stroke-color: var(--offline);
}
...
.scroller-2LSbBU::-webkit-scrollbar-track-piece,
.contentRegionScroller-26nc1e::-webkit-scrollbar-track,
.contentRegionScroller-26nc1e::-webkit-scrollbar-track-piece {
  background-color: transparent !important;
  border-color: transparent !important;
}
...
.contentRegionScroller-26nc1e::-webkit-scrollbar-thumb {
  background-color: var(--main-color) !important;
  border-color: transparent !important;
  border-radius: 40px;
}
...
.layer-v9HyYc[id*="popout"][style*="absolute; right:"] {
...
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='recent'],
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='recent'].categoryItemDefaultCategorySelected-_HCKoz,
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='recent']:hover {
  background-image: url(https://monstrousdev.github.io/themes/assets/emojiCategory/frequent.svg) !important
}

.categoryItemDefaultCategory-aBZ6nJ[aria-label*='people'],
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='people'].categoryItemDefaultCategorySelected-_HCKoz,
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='people']:hover {
  background-image: url(https://monstrousdev.github.io/themes/assets/emojiCategory/people.svg) !important
}

.categoryItemDefaultCategory-aBZ6nJ[aria-label*='nature'],
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='nature'].categoryItemDefaultCategorySelected-_HCKoz,
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='nature']:hover {
  background-image: url(https://monstrousdev.github.io/themes/assets/emojiCategory/nature.svg) !important
}

.categoryItemDefaultCategory-aBZ6nJ[aria-label*='food'],
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='food'].categoryItemDefaultCategorySelected-_HCKoz,
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='food']:hover {
  background-image: url(https://monstrousdev.github.io/themes/assets/emojiCategory/food.svg) !important
}

.categoryItemDefaultCategory-aBZ6nJ[aria-label*='activity'],
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='activity'].categoryItemDefaultCategorySelected-_HCKoz,
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='activity']:hover {
  background-image: url(https://monstrousdev.github.io/themes/assets/emojiCategory/activity.svg) !important
}

.categoryItemDefaultCategory-aBZ6nJ[aria-label*='travel'],
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='travel'].categoryItemDefaultCategorySelected-_HCKoz,
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='travel']:hover {
  background-image: url(https://monstrousdev.github.io/themes/assets/emojiCategory/travel.svg) !important
}

.categoryItemDefaultCategory-aBZ6nJ[aria-label*='objects'],
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='objects'].categoryItemDefaultCategorySelected-_HCKoz,
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='objects']:hover {
  background-image: url(https://monstrousdev.github.io/themes/assets/emojiCategory/objects.svg) !important
}

.categoryItemDefaultCategory-aBZ6nJ[aria-label*='symbols'],
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='symbols'].categoryItemDefaultCategorySelected-_HCKoz,
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='symbols']:hover {
  background-image: url(https://monstrousdev.github.io/themes/assets/emojiCategory/symbols.svg) !important
}

.categoryItemDefaultCategory-aBZ6nJ[aria-label*='flags'],
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='flags'].categoryItemDefaultCategorySelected-_HCKoz,
.categoryItemDefaultCategory-aBZ6nJ[aria-label*='flags']:hover {
...
.roleRemoveIcon-2-TeGW path:first-child {
  fill: rgba(0,0,0,.8) !important;
}

.roleRemoveIcon-2-TeGW path:last-child {
  transform: scale(0.6);
...
.optionLabel-2CkCZx,
#app-mount .css-n57xjs-menu .css-1ye7vu0 [class*="-option"] {
  border: 1px solid transparent;
}
...
.item-1Yvehc.itemSubMenu-1vN_Yn:hover::after {
  ...
  #status-picker .item-1tOPte:not(:nth-child(7)) .status-1fhblQ {
    color: transparent;
  }
  
  #status-picker .item-1tOPte .description-2L932D,
  ...
  #status-picker .item-1tOPte .statusItem-33LqPf {
    display: block;
    position: relative;
    height: 100%;
    width: 100%;
  ...
  #status-picker .item-1tOPte:hover {
    background: transparent !important;
  }
  ...
  #status-picker .item-1tOPte:nth-child(7):hover {
    background-color: var(--quaternary-color) !important;
    color: var(--main-color);
  }
  
  #status-picker .item-1tOPte:nth-child(7) > div {
    position: relative;
    width: 100%;
  }
  
  #status-picker .item-1tOPte:nth-child(7) .customStatusWithEmoji-8-XZ8I,
  #status-picker .item-1tOPte:nth-child(7) .statusItem-33LqPf {
    display: flex;
    flex-flow: row wrap;
    justify-content: flex-start;
    padding: 0 15px;
  ...
  #status-picker .item-1tOPte:nth-child(7) .status-1fhblQ,
  #status-picker .item-1tOPte:nth-child(7) .customText-tY5LJn {
    margin-left: 10px;
    max-width: 75%;
  }
  
  #status-picker .item-1tOPte:hover .icon-1IxfJ2 {
    transform: scale(1.9);
    transition: all 200ms ease-in-out;
  }
  
  #status-picker .item-1tOPte .icon-1IxfJ2 {
    position: absolute;
    width: 40px;
    height: 40px;
    top: 0;
  ...
  #status-picker .item-1tOPte:nth-child(1) .icon-1IxfJ2,
  #status-picker .item-1tOPte:nth-child(1):hover .icon-1IxfJ2 {
    color: var(--online);
    border-radius: 0;
  }
  
  #status-picker .item-1tOPte:nth-child(3) .icon-1IxfJ2,
  #status-picker .item-1tOPte:nth-child(3):hover .icon-1IxfJ2 {
    color: var(--idle);
    border-radius: 0;
  }
  
  #status-picker .item-1tOPte:nth-child(4) .icon-1IxfJ2,
  #status-picker .item-1tOPte:nth-child(4):hover .icon-1IxfJ2 {
    color: var(--dnd);
    border-radius: 0;
  }
  
  #status-picker .item-1tOPte:nth-child(5) .icon-1IxfJ2,
  #status-picker .item-1tOPte:nth-child(5):hover .icon-1IxfJ2 {
    color: var(--invisible);
    border-radius: 0;
  }
  
  #status-picker .item-1tOPte:hover [class*="status"].online-2S838R:after,
  #status-picker .item-1tOPte:hover [class*="status"].idle-3DEnRT:after,
  #status-picker .item-1tOPte:hover [class*="status"].dnd-1_xrcq:after,
  #status-picker .item-1tOPte:hover [class*="status"].invisible-1kp8Z0:after {
    opacity: 1;
    visibility: visible;
  }
  
  #status-picker .item-1tOPte [class*="status"].online-2S838R:after,
  #status-picker .item-1tOPte [class*="status"].idle-3DEnRT:after,
  #status-picker .item-1tOPte [class*="status"].dnd-1_xrcq:after,
  #status-picker .item-1tOPte [class*="status"].invisible-1kp8Z0:after {
    content: " ";
    display: block;
    position: absolute;
    width: 26px;
...
.theme-light .root-1gCeng {
  --header-primary: var(--main-color);
  box-shadow: 0 0 0 1px rgba(0,0,0,.3), 0 2px 10px 0 rgba(0,0,0,.1);
}
...
.theme-light .root-1gCeng  .colorHeaderSecondary-3Sp3Ft {
  color: #888;
}

.theme-light .root-1gCeng .itemContainer-1LSFks {
  background-color: var(--tertiary-color);
  transition: 200ms;
}

.theme-light .root-1gCeng .itemContainer-1LSFks:hover {
  background-color: var(--quaternary-color);
}

.theme-light .root-1gCeng .input--jS-j2 {
  background: transparent;
}

.theme-light .root-1gCeng .colorStandard-2KCXvj,
.uploadIcon-2IFzZU .iconContainer-2B0ixr,
.theme-light .root-1gCeng .input-cIJ7To,
.theme-light .root-1gCeng .lookBlank-3eh9lL,
...
.theme-light .root-1gCeng .lookBlank-3eh9lL:hover,
.theme-light .lookLink-9FtZy-.colorPrimary-3b3xI6:hover {
  color: #ccc;
  text-decoration: underline;
}

.uploadIcon-2IFzZU .iconContainer-2B0ixr svg circle {
...
.updateBadge-3EKJEV {
  background: var(--main-color);
  -webkit-mask: url(https://discordapp.com/assets/2da087637693ad611a1ac582115eea91.svg)
}
